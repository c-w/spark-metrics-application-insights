 ...
 *
 * Originally from https://github.com/shtratos/dropwizard-metrics-appinsights-reporter
 */
@ThreadSafe
public final class AppInsightsReporter extends ScheduledReporter {
    ...
    public void report(SortedMap<String, Gauge> gauges, SortedMap<String, Counter> counters,
        ...
        try {
            ...
            LOG.warn("Null pointer exception when polling metrics. Might mean SparkContext is shutting down", npe);
        }
    }
